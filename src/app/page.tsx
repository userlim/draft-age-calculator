    ...
    <>
      ...
      <section id="content-depth-section" className="mt-20 max-w-3xl mx-auto px-6 relative z-[1]">
        <h2 className="text-h2 mb-6 text-[#191F28]">Complete Guide</h2>
            ...
            <div className="mb-6">
              <h3 className="text-h3 mb-2 text-[#191F28]">Understanding the US Selective Service System</h3>
            ...
            <div className="mb-6">
              <h3 className="text-h3 mb-2 text-[#191F28]">Who Must Register and When</h3>
            ...
            <div className="mb-6">
              <h3 className="text-h3 mb-2 text-[#191F28]">Consequences of Not Registering</h3>
            ...
            <div className="mb-6">
              <h3 className="text-h3 mb-2 text-[#191F28]">History of the US Military Draft</h3>
            ...
            <div className="mb-6">
              <h3 className="text-h3 mb-2 text-[#191F28]">Current Draft Debates and Proposed Changes</h3>
